...
/*Checks if a user_id cookie is set. If it is, retrieves the user ID; otherwise, redirects to login.php. 
This ensures that only logged-in users can access the profile update page.
 */
