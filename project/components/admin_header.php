...
<header class="header">
   ...
   <img src="https://www.ckthakurcollege.net/maindesign/images/logo-batch.png" alt="Company Logo">
</a>
...
<div class="side-bar">
   ...
   <!--The PHP code queries the database for a tutor's profile using their tutor_id.
If the tutor exists, it displays their profile image, name, profession, and a link to their profile.
If the tutor does not exist, it prompts the user to login or register.  -->
